...
export const dummyTransaksi: TransaksiGadai[] = [
  ...
  },
  {
    ...
    tanggal_gadai: "2024-01-25",
    tanggal_jatuh_tempo: "2024-04-25",
    tanggal_pelunasan: "2024-04-20",
    status: "lunas",
    created_at: "2024-01-25",
  },
  {
    id: "trx-006",
    nomor_transaksi: "TRX-2024-006",
    nasabah_id: "nsb-006",
    nasabah_nama: "Rina Handayani",
    barang_id: "brg-006",
...
export const dummyPembayaran: Pembayaran[] = [
  ...
  },
  {
    ...
    jumlah: 5300000,
    metode: "transfer",
    tanggal_bayar: "2024-04-20",
    keterangan: "Pelunasan pokok + ujrah",
  },
  {
    id: "pay-004",
    nomor_pembayaran: "PAY-2024-004",
